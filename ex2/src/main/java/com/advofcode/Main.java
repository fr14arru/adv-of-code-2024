...
public class Main {
    ...
    private static void part1() {
        ...
        for (String line : lines) {
            ...
            if (Boolean.TRUE.equals(validLine(numbers))) {

                safeLinesCount++;
            }
        }

        System.out.println(safeLinesCount);
    }
    ...
    private static void part2() {
        ...
        for (String line : lines) {
            ...
            Boolean validLine = validLine(numbers);

            if (Boolean.FALSE.equals(validLine)) {

                int positionWithError = 0;

                while (Boolean.FALSE.equals(validLine) && positionWithError < numbers.size()) {

                    List<Integer> numbersWithPositionOfError = new ArrayList<>(numbers);
                    numbersWithPositionOfError.remove(positionWithError);

                    if (Boolean.TRUE.equals(validLine(numbersWithPositionOfError))) {
    ...
    private static boolean validLine(List<Integer> numbers) {

        Boolean ascOrder = null;
        boolean validLine = Boolean.TRUE;

        for (int i = 0; i < (numbers.size() - 1) && Boolean.TRUE.equals(validLine); i++) {

            Integer num1 = numbers.get(i);
            Integer num2 = numbers.get(i + 1);
            ...
            if (ascOrder == null) {
                ...
                if (Boolean.TRUE.equals(ascOrder) && num1 > num2 ||
                        Boolean.FALSE.equals(ascOrder) && num1 < num2 ||
                        num1.equals(num2)) {
